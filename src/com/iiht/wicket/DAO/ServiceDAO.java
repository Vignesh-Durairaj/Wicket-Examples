...
public class ServiceDAO {
	...
	public static TypeModel getSampleType() {
	...
	public static TelecomModel getSampleService() {
	...
	public static List<TypeModel> getTypeList() {
	...
	public static List<TelecomModel> getServiceProvidersList () {
	...
	public static TypeModel getTypeFromList (final Integer typeId) {
